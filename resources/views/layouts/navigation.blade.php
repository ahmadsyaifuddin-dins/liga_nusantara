    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('bola.png') }}" alt="Logo" class="w-12 h-12">
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @if(Auth::user()->role === 'SuperAdmin')
                <form method="POST" action="{{ route('app.toggle') }}">
                    @csrf
                    <button type="submit"
                        class="{{ \App\Models\Setting::getValue('app_active') === 'true' ? 'text-red-600 hover:bg-red-100' : 'text-green-600 hover:bg-green-100' }} block w-full text-left px-4 py-2 text-sm dark:hover:bg-gray-700">
                        {{ \App\Models\Setting::getValue('app_active') === 'true' ? 'Nonaktifkan Website' : 'Aktifkan
                        Website' }}
                    </button>
                </form>
                @endif

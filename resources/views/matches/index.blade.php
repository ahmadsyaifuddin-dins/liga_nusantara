<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            @if(session('success'))
            <div
                class="mb-6 p-4 bg-gradient-to-r from-green-50 to-green-100 border border-green-200 text-green-800 rounded-xl shadow-sm">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div
                                            class="flex items-center justify-center w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-full text-sm font-bold">
                                            {{ $index + 1 }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm font-medium text-gray-900 dark:text-white">{{ $match->judul
                                            }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-500 dark:text-gray-400">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <span
                                                    ...
                                                    $match->winner->name }}</span>
                                            </div>
                                            @else
                                            <div class="flex items-center space-x-2">
                                                <div class="w-2 h-2 bg-yellow-500 rounded-full"></div>
                                                <span
                                                    class="text-sm font-medium text-yellow-600 dark:text-yellow-400">Seri</span>
                                            </div>
                                            @endif
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <a href="{{ url('laravel/public/' . $match->documentation) }}" target="_blank"
                                            class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800 hover:bg-blue-200 dark:bg-blue-800 dark:text-blue-100 dark:hover:bg-blue-700 transition-colors duration-200">
                                        ...
                                        @else
                                        <span
                                            class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-500 dark:bg-gray-700 dark:text-gray-400">
                                            Tidak ada
                                        </span>
                                        @endif
                                    </td>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-blue-100 text-sm">{{ $match->created_at->format('d M Y, H:i') }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="p-4 space-y-4">
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    @foreach($match->players as $player)
                                    <div
                                        class="flex items-center justify-between bg-gray-50 dark:bg-gray-700 rounded-xl p-3">
                                        <div class="flex items-center space-x-3">
                                            <div
                                                class="w-10 h-10 bg-gradient-to-r from-gray-400 to-gray-600 rounded-full flex items-center justify-center">
                                                <span class="text-white font-bold text-sm">{{
                                                    substr($player->user->name, 0, 1) }}</span>
                                            </div>
                                            <div>
                                                ...
                                                @if($player->is_winner)
                                                <span
                                                    class="inline-flex items-center text-xs font-medium text-green-600 dark:text-green-400">
                                                    🏆 Pemenang
                                                </span>
                                                @endif
                                            </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span
                                        class="text-sm font-medium text-gray-700 dark:text-gray-300">Dokumentasi:</span>
                                </div>
                                @if($match->documentation)
                                <a href="{{ url('laravel/public/' . $match->documentation) }}" target="_blank"
                                    class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800 hover:bg-blue-200 dark:bg-blue-800 dark:text-blue-100 dark:hover:bg-blue-700 transition-colors duration-200">

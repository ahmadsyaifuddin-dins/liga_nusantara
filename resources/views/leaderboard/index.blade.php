                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="bg-white bg-opacity-20 rounded-full p-3">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24"
                                ...
                                <path d="M6 20a6 6 0 0 1 12 0H6z" />

                                <!-- orang kiri -->
                                <circle cx="5" cy="9" r="2" />
                                <path d="M1 20a4 4 0 0 1 6-3" />

                                <!-- orang kanan -->
                                <circle cx="19" cy="9" r="2" />
                                <path d="M17 17a4 4 0 0 1 6 3" />
                            </svg>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="bg-white bg-opacity-20 rounded-full p-3">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none"
                                ...
                                <title id="title">Trophy Icon (Outline)</title>
                                <desc id="desc">Ikon piala garis, dengan gagang kiri kanan, batang, dan dasar.</desc>

                                <!-- mangkuk piala -->
                                <path d="M6 4h12v3a6 6 0 0 1-6 6 6 6 0 0 1-6-6V4z" />
                                <!-- gagang kiri & kanan -->
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr
                                    class="bg-white dark:bg-gray-800 hover:bg-slate-950 dark:hover:bg-gray-750 transition-colors duration-200">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            @if($index == 0)
                                            <div
                                                class="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-yellow-400 to-yellow-600 text-white rounded-full text-lg font-bold shadow-lg">
                                                👑
                                            </div>
                                            @elseif($index == 1)
                                            <div
                                                class="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-gray-400 to-gray-600 text-white rounded-full text-sm font-bold shadow-lg">
                                                🥈
                                            </div>
                                            @elseif($index == 2)
                                            <div
                                                class="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-orange-400 to-orange-600 text-white rounded-full text-sm font-bold shadow-lg">
                                                🥉
                                            </div>
                                            @else
                                            <div
                                                class="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-full text-sm font-bold">
                                                {{ $index + 1 }}
                                            </div>
                                            @endif
                                        </div>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div
                                                class="flex-shrink-0 w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full flex items-center justify-center mr-4">
                                                <span class="text-white font-bold text-lg">{{ substr($player->name, 0,
                                                    1) }}</span>
                                            </div>
                                            <div>
                                                <a href="{{ route('players.profile', $player->id) }}"
                                                    class="text-lg font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition-colors duration-200">
                                                    {{ $player->name }}
                                                </a>
                                                @if($index == 0)
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex items-center justify-center">
                                            <span
                                                class="inline-flex items-center px-3 py-1 rounded-full text-sm font-bold bg-yellow-100 text-yellow-800 dark:bg-yellow-800 dark:text-yellow-100">
                                                🏆 {{ $player->wins }}
                                            </span>
                                        </div>
                                    </td>
                                    ...
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-500 dark:text-gray-400 text-lg font-medium">Belum ada
                                                data klasemen</p>
                                            <p class="text-gray-400 dark:text-gray-500 text-sm mt-1">Mulai bermain untuk
                                                melihat peringkat</p>
                                        </div>
                                    </td>
                                </tr>
            ...
            <div class="md:hidden">
                <div class="space-y-4">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            <div class="flex items-center space-x-4 mb-4">
                                <div
                                    class="w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full flex items-center justify-center">
                                    <span class="text-white font-bold text-xl">{{ substr($player->name, 0, 1) }}</span>
                                </div>
                                <div class="flex-1">
                                    <a href="{{ route('players.profile', $player->id) }}"
                                        class="text-xl font-bold text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                                        {{ $player->name }}
                                    </a>
                                    @if($index == 0)
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <div
                                    class="text-center bg-yellow-50 dark:bg-yellow-900 dark:bg-opacity-20 rounded-xl p-3">
                                ...
                                <div class="text-center bg-blue-50 dark:bg-blue-900 dark:bg-opacity-20 rounded-xl p-3">
                                    <div class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ $player->matches
                                        }}</div>
                                    <div class="text-xs text-blue-600 dark:text-blue-400 font-medium">Final</div>
                                </div>
                                <div
                                    class="text-center bg-purple-50 dark:bg-purple-900 dark:bg-opacity-20 rounded-xl p-3">
                                    <div class="text-2xl font-bold text-purple-600 dark:text-purple-400">{{
                                        number_format($player->avg_score, 1) }}</div>
                                    <div class="text-xs text-purple-600 dark:text-purple-400 font-medium">Rata-rata
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 bg-gray-50 dark:bg-gray-700 rounded-xl p-3">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <span class="text-sm font-bold text-gray-900 dark:text-white">
                                        {{ $player->matches > 0 ? number_format(($player->wins / $player->matches) *
                                        100, 1) : 0 }}%
                                    </span>
                                </div>
                                <div class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
                                    <div class="bg-gradient-to-r from-green-500 to-green-600 h-2 rounded-full"
                                        style="width: {{ $player->matches > 0 ? ($player->wins / $player->matches) * 100 : 0 }}%">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 text-center">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Belum ada data klasemen
                        </h3>
